...
,
					...
					"patching_rect" : [ 259.0, 223.0, 346.0, 22.0 ],
					"rnboattrcache" : 					{
						"listen_4" : 						{
							"label" : "listen_4",
							"isEnum" : 0,
...
,
							"__presetid" : "pulse.4voice_bells_web_params.rnbopat",
							"listen_2" : 							{
								"value" : 0.07
							}
,
...
,
						"snapshotlist" : 						{
							...
							"entries" : [ 								{
									...
									"minorversion" : 0,
									"name" : "pco.4voice",
									"origin" : "pulse.4voice_bells_web_params.rnbopat",
									"type" : "rnbo",
									"subtype" : "",
									"embed" : 1,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										...
										"filepos" : -1,
										"snapshotfileid" : "8090d6167e5495d2b9be23cb79cf075f"
									}
...
,
					"text" : "rnbo~ @patchername pulse.4voice_bells_web_params.rnbopat",
					"varname" : "rnbo~"
				}
...
, 			{
				"name" : "pulse.4voice_bells_web_params.rnbopat",
